...
<div class="pe-index-t">
  		<p class="pe-index-t-c">真实姓名 <span><input class="card-yy" id="truename" name="truename" type="text" maxlength="10" value="<?php echo ($name); ?>"></span> </p>
  		
  		<p class="pe-index-t-c">银行名称 <span><input class="card-yy" id="name" name="name" type="text" value="<?php echo ($list["name"]); ?>"></span> </p>
  		
  		<p class="pe-index-t-c">银行名称 
  			<span style="width: 67%;">
