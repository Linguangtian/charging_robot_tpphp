  		...
  		<form action="" id="myform" method="post"style="margin-top:0px">
            ...
            <div class="input-container">
                <div class="input-control">
                    ...
                    <input class="inputfield" type="text" id="truename" name="truename" placeholder="请输入真实姓名" value="">
                </div>
            </div>
            ...
            <div class="input-container">
                    ...
                    <div class="input-container">
                      ...
                      <div class="input-container">
                        <div class="input-control">
                            <i class="icon iconfont icon-mima"></i>
                            <input class="inputfield" type="password" id="password" name="password" placeholder="确定登录密码" value="">
                        </div>
                    </div>
