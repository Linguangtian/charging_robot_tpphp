...
<html class="pixel-ratio-3 retina android android-5 android-5-0 watch-active-state"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <style type="text/css">
       ...
       .tixian-h  input{ height: 1.5rem;}
       .tixian-h .item-input span{ width: 30%;min-width: 5rem; color: #ffffff !important;}
       .tixian-h .item-input{
...
<body style="background: #131933;">
	...
	<div class="wi-tix" style="height: auto;">
		<p class="wi-tix-ktx">申请提现<span><a href="<?php echo U('Index/Wallet/withdrawnlog');?>" style="color: #FEB620;">提现记录</a></span> </p>
		...
		<div class="item-content tixian-h">
           ...
           <!--<div class="item-inner">
              <div class="item-input">
                     <select id="type" name="type" maxlength="50" style="color: rgba(220, 235, 245, 1);width: 100%;height: 2rem;border: none;background: rgba(33, 37, 68, 1);padding: 0 1rem;">
        ...
        <div class="item-content tixian-h">
            <div class="item-input">
                ...
                <select id="kaihuhang" name="kaihuhang" maxlength="50" style="width: 70%;display: inline-block;height: 2rem;margin-top: 0.5rem;border: none;border-radius: 1rem;">
                    <option value="" selected="selected">请选择</option>
