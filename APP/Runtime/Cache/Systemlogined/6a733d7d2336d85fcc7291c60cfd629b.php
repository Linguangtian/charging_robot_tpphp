				...
				<div id="page-content" class="clearfix">
					...
					<div class="row-fluid">
						<!--PAGE CONTENT BEGINS HERE-->
							<form name="editAnnounceType" class="form-horizontal"  method="post">
								<div class="control-group">
									<label class="control-label" for="username"> 手机号码</label>

									<div class="controls">
										<input type="number"  maxlength="11" onkeyup="this.value=this.value.replace(/\D/g,'')"   name="username" value="" id="username"/>
									</div>
								</div>
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" name="truename" value="" id="truename"/>
									</div>
								</div>
								...
								<div class="control-group">
									<label class="control-label" for="parent_username"> 推荐人手机号码</label>
									<div class="controls">
										<input type="number"  maxlength="11" onkeyup="this.value=this.value.replace(/\D/g,'')"   name="parent_username" value="" id="parent_username"/>
									</div>
								</div>
