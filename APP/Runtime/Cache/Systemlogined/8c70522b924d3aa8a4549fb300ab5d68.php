				...
				<div id="page-content" class="clearfix">
					...
					<div class="row-fluid">
						<!--PAGE CONTENT BEGINS HERE-->
							<form class="form-horizontal" name="editordertime"  enctype="multipart/form-data" method="post">
							<input type="hidden"  name="id" value="<?php echo ($order["id"]); ?>">
								<div class="control-group">
									<label class="control-label" for="member"> 服务器编号</label>
                                    <div class="controls">
										<input type="text" value="<?php echo ($order["kjbh"]); ?>"  disabled />
									</div>
								</div>

								<div class="control-group">
									<label class="control-label" for="member"> 会员</label>
                                    <div class="controls">
										<input type="text" value="<?php echo ($order["user"]); ?>"  disabled />
									</div>
								</div>

								<div class="control-group">
									<label class="control-label" for="member"> 购买时间</label>
                                    <div class="controls">
										<input type="text" value="<?php echo ($order["addtime"]); ?>"  disabled />
									</div>
								</div>

								<div class="control-group">
									<label class="control-label" for="member"> 截止时间</label>
                                    <div class="controls">
										<input type="text" value="<?php echo ($order["end_str_time"]); ?>"  disabled />
									</div>
								</div>
								...
								<div class="control-group">
									<label class="control-label" for="member"> 需要延长</label>
									<div class="controls">
										<input type="number" value="1" name="addtime"   />/小时
									</div>
								</div>
