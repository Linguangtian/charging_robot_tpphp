				...
				<div id="page-content" class="clearfix">
					...
					<div class="row-fluid">
						<!--PAGE CONTENT BEGINS HERE-->
							<form class="form-horizontal" onsubmit="return check();" action="<?php echo U(GROUP_NAME.'/Rbac/addUserHandle');?>" name="adduser" method="post">
								<div class="control-group">
									<label class="control-label" for="username"> 用户名</label>

									<div class="controls">
										<input type="text" value="" name="username" id="username" placeholder="" />
									</div>
								</div>
								<div class="control-group">
								...
								<div class="control-group">
									...
									<div class="controls">
											<?php if(is_array($role)): foreach($role as $key=>$v): ?><lable>
													<input name="role_id[]" type="checkbox" value="<?php echo ($v["id"]); ?>"/>
													<span class="lbl"> <?php echo ($v["remark"]); ?></span>
