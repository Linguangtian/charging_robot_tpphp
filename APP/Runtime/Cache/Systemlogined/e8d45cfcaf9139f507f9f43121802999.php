				...
				<div id="page-content" class="clearfix">
					<div class="page-header position-relative">
						<div style="text-align:left;width:100%;">
							<a type="button" href="/index.php/systemlogined/shop/edit_phb" class="btn btn-info btn-small no-border"> <i class="icon-plus icon-white"></i>添加</a>
						</div>
					</div>
					<div class="row-fluid">
								...
								<tbody>
                                    <?php if(is_array($list)): foreach($list as $key=>$v): ?><tbody> 
									    ...
									    <td class="hidden-480"><?php echo ($v["money"]); ?></td>
											...
											<td>
											<a href="<?php echo U(GROUP_NAME .'/shop/edit_phb',array('id'=>$v['id']));?>">修改</a> |
											<a onclick="if(confirm('确认删除此信息吗?')==false)return false;" href="<?php echo U(GROUP_NAME .'/shop/del_phb',array('id'=>$v['id']));?>">删除</a>
										</td>
