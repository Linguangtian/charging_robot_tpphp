				...
				<div id="page-content" class="clearfix">
					...
					<div class="row-fluid">
						<!--PAGE CONTENT BEGINS HERE-->
							<form class="form-horizontal" name="editOrderHandle"  enctype="multipart/form-data" method="post">
							<input type="hidden"  name="id" value="<?php echo ($id); ?>">


								<div class="control-group">
									<label class="control-label" for="user_name"> 联系手机</label>
                                    <div class="controls">
										<input type="number" maxlength="11" value="<?php echo ($info["user_name"]); ?>" name="user_name"  />
									</div>
								</div>

								<div class="control-group">
									<label class="control-label" for="money"> 收益</label>
									<div class="controls">
										<input type="text" value="<?php echo ($info["money"]); ?>" name="money"  />
									</div>
								</div>
