						...
						<!--PAGE CONTENT BEGINS HERE-->
							...
							<input type="hidden"  name="id" value="<?php echo ($product["id"]); ?>">
								<div class="control-group">
									<label class="control-label" for="title"> 5G服务器名称</label>
								...
								<div class="control-group">
									<label class="control-label" for="is_cumulative"> 是否有效服务器</label>

									<div class="controls">
										<input type="radio"   <?php if($product['is_cumulative'] == 1 ): ?>checked<?php endif; ?>  value="1" name="is_cumulative" >
										<span class="lbl"> 是</span>
										<input type="radio"  <?php if($product['is_cumulative'] == 2 ): ?>checked<?php endif; ?> value="2" name="is_cumulative">
