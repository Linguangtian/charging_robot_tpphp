				...
				<div id="page-content" class="clearfix">
					...
					<div class="row-fluid">
						<!--PAGE CONTENT BEGINS HERE-->
							<form class="form-horizontal" name="editOrderHandle"  enctype="multipart/form-data" action="<?php echo U(GROUP_NAME .'/Shop/editOrderHandle');?>" method="post">
							<input type="hidden"  name="id" value="<?php echo ($order["id"]); ?>">
								<div class="control-group">
									<label class="control-label" for="member"> 用户</label>
                                    <div class="controls">
										<input type="text" value="<?php echo ($order["member"]); ?>" name="member" disabled />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="title"> 商品名称</label>
                                    <div class="controls">
										<input type="text" value="<?php echo ($order["stitle"]); ?>" name="title" disabled />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="num"> 购买数量</label>
                                    <div class="controls">
										<input type="text" value="<?php echo ($order["num"]); ?>" name="num" disabled />
									</div>
								</div>	
								<div class="control-group">
									<label class="control-label" for="num"> 支付方式</label>
                                    <div class="controls">
					
										<input type="text" value="现金支付" name="type" disabled />

									</div>
								</div>									
								<div class="control-group">
									<label class="control-label" for="money"> 总价</label>
                                    <div class="controls">
										<input type="text" value="<?php echo ($order["money"]); ?>" name="money" disabled />
									</div>
								</div>	
								<div class="control-group">
									<label class="control-label" for="realname"> 收货人</label>
                                    <div class="controls">
										<input type="text" value="<?php echo ($order["realname"]); ?>" name="realname" disabled />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="mobile"> 联系手机</label>
                                    <div class="controls">
										<input type="text" value="<?php echo ($order["mobile"]); ?>" name="mobile" disabled />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="post"> 邮政编码</label>
                                    <div class="controls">
										<input type="text" value="<?php echo ($order["post"]); ?>" name="post" disabled />
									</div>
								</div>
								<div class="control-group">
									<label class="control-label" for="address"> 地址</label>
                                    <div class="controls">
										<input type="text" value="<?php echo ($order["address"]); ?>" name="address" disabled />
									</div>
								</div>								
                                 <div class="control-group">
											<label class="control-label" for="address"> 订单状态</label>		
                                            <div class="controls">	
                                       <?php if($order['status'] == 1): ?><input type="radio" value="1" checked="checked" name="status">
																<span class="lbl">未发货</span>
																&nbsp;
											<input type="radio" value="2" name="status">
																<span class="lbl">已发货</span>
									   <?php elseif($order['status'] == 2): ?>
											<input type="radio" value="1" disabled name="status">
																<span class="lbl">未发货</span>
																&nbsp;
																<input type="radio"   disabled checked="checked" value="2" name="status">
																<span class="lbl">已发货</span><?php endif; ?>											

														</div>
								</div>
								<!--
								<div class="control-group">
									<label class="control-label" for="reply"> 系统回复</label>

									<div class="controls">
										<textarea name="reply" id="reply" style="width:700px; height:300px"><?php echo ($order["reply"]); ?></textarea>
									</div>
								</div>
              				-->
							 <?php if($order['status'] != 2): ?><div class="form-actions">
